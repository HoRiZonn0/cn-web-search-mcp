        ...
        return json.dumps(
            {
                ...
                "rest_api_host": settings.api_host,
                "rest_api_port": settings.api_port,
                "rest_api_auth_configured": bool(settings.api_bearer_token),
                "rest_api_sync_timeout_seconds": settings.api_sync_timeout_seconds,
            },
            ensure_ascii=False,
            indent=2,
        )
